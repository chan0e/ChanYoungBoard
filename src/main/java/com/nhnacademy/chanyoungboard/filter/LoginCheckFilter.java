package com.nhnacademy.chanyoungboard.filter;

import com.nhnacademy.chanyoungboard.config.CommonPropertiesConfig;
...
public class LoginCheckFilter implements Filter {
    ...
    private boolean isExcludeUrl(String path){
        long count = excludeUrls.stream().filter(o-> path.contains(o)).count();
